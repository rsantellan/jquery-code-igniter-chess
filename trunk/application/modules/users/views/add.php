...
<div class="section">
	<div class="section_inner">
		<div class="title_wrapper">
			<h2><?php echo lang("form_editar formulario usuarios");?></h2>
				...
				<div class="row">
					...
					<div class="inputs">
						<span class="input_wrapper">
						  <input id="USER_ADM_ID" class="text" type="text" name="USER_ADM_ID" maxlength="32" value="<?php echo set_value('USER_ADM_ID'); ?>"  />
						</span>
...
<!--						<span class="system positive">This is a positive message</span>-->
				...
				<div class="row">
					...
					<div class="inputs">
						<span class="input_wrapper">
						  <input id="USER_NAME" class="text" type="text" name="USER_NAME" maxlength="32" value="<?php echo set_value('USER_NAME'); ?>"  />
						</span>
...
<!--						<span class="system negative">This is a negative message</span>-->
				...
				<div class="row">
					...
					<div class="inputs">
						<span class="input_wrapper blank">
							...
							<?php echo form_dropdown('USER_PROFILE_ID', $user_profile_list, set_value('USER_PROFILE_ID'))?>
						</span>
					</div>
				...
				<div class="row">
					...
					<div class="inputs">
						<span class="input_wrapper blank">
							<?php echo form_dropdown('STATUS', $status_list, set_value('STATUS'))?>
						</span>
					</div>
				...
				<div class="row">
					...
					<div class="inputs">
						<span class="input_wrapper">
						  <input id="EXPIRE_DATE" class="text" type="text" name="EXPIRE_DATE"  value="<?php echo set_value('EXPIRE_DATE'); ?>"  />
						</span>
